...
// 	containerId := strings.Split(c.Request.Host, ".")[0]

// 	containerInfo, err := ReadContainersData(containerId)
// 	if err != nil {
// 		c.JSON(500, gin.H{
...
// 		var cmd *exec.Cmd
// 		if command.Data != "" {
// 			err := WriteFileToContainer(containerInfo.ContainerID, contain, filepath.Join(command.Dir, command.IsFile), command.Data)
// 			if err != nil {
